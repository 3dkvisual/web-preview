...
const translations = {
  es: {
    ...
    'about.p1': '3DK Visual es un estudio CGI de Buenos Aires especializado en FOOH, DOOH, animación 3D e IA generativa para marcas globales. <strong>+1.000 proyectos</strong> y <strong>+100 clientes</strong> en publicidad, motion y branded content.',
    'about.p2': '',
  ...
  en: {
    ...
    'about.p1': '3DK Visual is a CGI studio from Buenos Aires specialized in FOOH, DOOH, 3D animation and generative AI for global brands. <strong>1,000+ projects</strong> and <strong>100+ clients</strong> in advertising, motion and branded content.',
